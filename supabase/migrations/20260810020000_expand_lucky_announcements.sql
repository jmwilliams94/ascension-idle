-- Expand which Lucky Lad reward kinds trigger a global announcement
-- (2026-08-10, follow-up to 20260808050000_global_announcements.sql).
-- Previously only Comet Scroll / Fallen Star Scroll announced. Confirmed
-- with the user: announce anything genuinely rare/exciting — Fallen Star,
-- both Gem tiers (Tempered/Ascended), and all 3 hyper-rare gear/random
-- kinds — while deliberately still skipping Money Bags and Composition
-- Stones even though some individual tiers happen to share Comet Scroll's
-- weight (8.0), since those already have their own frequent progression feel.
...
begin
  ...
  -- progression drip, not a standout win).
