      ...
      <AnimatePresence>
        {lastLevelUp !== null && (
          <motion.div
            ...
            className="relative rounded-lg border border-amber-400/60 bg-amber-400/10 px-4 py-2 text-center text-sm font-semibold text-amber-300 backdrop-blur will-change-transform"
          >
            {bursts.map((burst, i) => (
