...
function AnnouncementHistoryDropdown() {
  ...
  return (
    <div className="absolute left-0 top-full z-50 mt-1 w-72 rounded-lg border border-slate-700 bg-slate-900/95 p-2 shadow-xl sm:w-80">
...
export default function GlobalAnnouncementTicker() {
  ...
  if (collapsed) {
    return (
      <button
        ...
        className="shrink-0 rounded-lg border border-slate-700 bg-slate-900/60 px-2 py-1.5 text-xs text-slate-400 hover:border-slate-500 hover:text-slate-200 lg:px-3 lg:py-2 lg:text-sm"
      >
        📣 ▸
      </button>
    )
  ...
  return (
    <div className="relative min-w-0 max-w-full shrink sm:max-w-sm">
      <div className="flex items-center gap-2 rounded-lg border border-amber-600/50 bg-amber-500/10 px-3 py-1.5 text-xs font-medium text-amber-200 lg:gap-3 lg:px-4 lg:py-2 lg:text-sm">
