...
const ITEM_ICON_OVERRIDES: Record<string, string> = {
  ...
  'Knot Club': `${import.meta.env.BASE_URL}item-icons/knot-club.png`,
  'Rustcut Club': `${import.meta.env.BASE_URL}item-icons/rustcut-club.png`,
  'Rivet Club': `${import.meta.env.BASE_URL}item-icons/stub-club.png`,
  'Cudgel Club': `${import.meta.env.BASE_URL}item-icons/cudgel-club.png`,
  'Hardwood Club': `${import.meta.env.BASE_URL}item-icons/hardwood-club.png`,
  'Mastiff Club': `${import.meta.env.BASE_URL}item-icons/mastiff-club.png`,
  'Cane Club': `${import.meta.env.BASE_URL}item-icons/cane-club.png`,
  'Ferrule Club': `${import.meta.env.BASE_URL}item-icons/anvil-club.png`,
  'Legion Club': `${import.meta.env.BASE_URL}item-icons/legion-club.png`,
  'Warworn Club': `${import.meta.env.BASE_URL}item-icons/siege-club.png`,
  'Skirmish Club': `${import.meta.env.BASE_URL}item-icons/skirmish-club.png`,
  'Fang Club': `${import.meta.env.BASE_URL}item-icons/fang-club.png`,
  'Stinger Club': `${import.meta.env.BASE_URL}item-icons/stinger-club.png`,
  'Copper Club': `${import.meta.env.BASE_URL}item-icons/copper-club.png`,
  'Steel Club': `${import.meta.env.BASE_URL}item-icons/steel-club.png`,
  'Claw Club': `${import.meta.env.BASE_URL}item-icons/claw-club.png`,
  'Panther Club': `${import.meta.env.BASE_URL}item-icons/panther-club.png`,
  'Bone Club': `${import.meta.env.BASE_URL}item-icons/bone-club.png`,
  'Fin Club': `${import.meta.env.BASE_URL}item-icons/fin-club.png`,
  'Thunderhead Club': `${import.meta.env.BASE_URL}item-icons/serpent-club.png`,
  'Voltaic Club': `${import.meta.env.BASE_URL}item-icons/wyrm-club.png`,
  'Galeforge Club': `${import.meta.env.BASE_URL}item-icons/triumph-club.png`,
  'Maelstrom Club': `${import.meta.env.BASE_URL}item-icons/titan-club.png`,
  'Storm Club': `${import.meta.env.BASE_URL}item-icons/storm-club.png`,
  'Squall Club': `${import.meta.env.BASE_URL}item-icons/ruin-club.png`,
  'Sovereign Club': `${import.meta.env.BASE_URL}item-icons/crown-club.png`,
  ...
  'Squire Sword': `${import.meta.env.BASE_URL}item-icons/squire-sword.png`,
  'Coil Sword': `${import.meta.env.BASE_URL}item-icons/coil-sword.png`,
  'Shade Sword': `${import.meta.env.BASE_URL}item-icons/shade-sword.png`,
  'Gleam Sword': `${import.meta.env.BASE_URL}item-icons/gleam-sword.png`,
  'Quartz Sword': `${import.meta.env.BASE_URL}item-icons/quartz-sword.png`,
  'Cinder Sword': `${import.meta.env.BASE_URL}item-icons/cinder-sword.png`,
  'Obsidian Sword': `${import.meta.env.BASE_URL}item-icons/obsidian-sword.png`,
  'Ridge Sword': `${import.meta.env.BASE_URL}item-icons/ridge-sword.png`,
  'Calm Sword': `${import.meta.env.BASE_URL}item-icons/calm-sword.png`,
  'Tusk Sword': `${import.meta.env.BASE_URL}item-icons/tusk-sword.png`,
  'Glass Sword': `${import.meta.env.BASE_URL}item-icons/glass-sword.png`,
  'Flamberge': `${import.meta.env.BASE_URL}item-icons/flamberge.png`,
  'Rover Sword': `${import.meta.env.BASE_URL}item-icons/rover-sword.png`,
  'Marlin Sword': `${import.meta.env.BASE_URL}item-icons/marlin-sword.png`,
  'Radiant Sword': `${import.meta.env.BASE_URL}item-icons/radiant-sword.png`,
  'Dual Sword': `${import.meta.env.BASE_URL}item-icons/dual-sword.png`,
  'Prism Sword': `${import.meta.env.BASE_URL}item-icons/prism-sword.png`,
  'Great Sword': `${import.meta.env.BASE_URL}item-icons/great-sword.png`,
  'Oath Sword': `${import.meta.env.BASE_URL}item-icons/wyrm-sword.png`,
  'Creed Sword': `${import.meta.env.BASE_URL}item-icons/vow-sword.png`,
  'Sunray Sword': `${import.meta.env.BASE_URL}item-icons/soar-sword.png`,
  'Lucent Sword': `${import.meta.env.BASE_URL}item-icons/clear-sword.png`,
  'Umbra Sword': `${import.meta.env.BASE_URL}item-icons/abyss-sword.png`,
  ...
  'Pebble Wand': `${import.meta.env.BASE_URL}item-icons/pebble-wand.png`,
  'Stone Wand': `${import.meta.env.BASE_URL}item-icons/stone-wand.png`,
  'Heartwood Wand': `${import.meta.env.BASE_URL}item-icons/heartwood-wand.png`,
  'Clash Wand': `${import.meta.env.BASE_URL}item-icons/clash-wand.png`,
  'Despot Wand': `${import.meta.env.BASE_URL}item-icons/despot-wand.png`,
  'Temple Wand': `${import.meta.env.BASE_URL}item-icons/temple-wand.png`,
  'Legion Wand': `${import.meta.env.BASE_URL}item-icons/legion-wand.png`,
  'Lion Wand': `${import.meta.env.BASE_URL}item-icons/lion-wand.png`,
  'Epoch Wand': `${import.meta.env.BASE_URL}item-icons/epoch-wand.png`,
  'Sacred Wand': `${import.meta.env.BASE_URL}item-icons/sacred-wand.png`,
  'Bloom Wand': `${import.meta.env.BASE_URL}item-icons/bloom-wand.png`,
  'Strife Wand': `${import.meta.env.BASE_URL}item-icons/strife-wand.png`,
  'Truce Wand': `${import.meta.env.BASE_URL}item-icons/truce-wand.png`,
  'Forge Wand': `${import.meta.env.BASE_URL}item-icons/forge-wand.png`,
  'Alloy Wand': `${import.meta.env.BASE_URL}item-icons/alloy-wand.png`,
  'Summit Wand': `${import.meta.env.BASE_URL}item-icons/summit-wand.png`,
  'Wolf Wand': `${import.meta.env.BASE_URL}item-icons/wolf-wand.png`,
  'Purge Wand': `${import.meta.env.BASE_URL}item-icons/purge-wand.png`,
  'Stalwart Wand': `${import.meta.env.BASE_URL}item-icons/stalwart-wand.png`,
  'Bronze Wand': `${import.meta.env.BASE_URL}item-icons/bronze-wand.png`,
  'Platinum Wand': `${import.meta.env.BASE_URL}item-icons/platinum-wand.png`,
  'Colossus Wand': `${import.meta.env.BASE_URL}item-icons/drake-wand.png`,
  'Cairn Wand': `${import.meta.env.BASE_URL}item-icons/victory-wand.png`,
  ...
  'Willow Backsword': `${import.meta.env.BASE_URL}item-icons/willow-backsword.png`,
  'Moonlit Backsword': `${import.meta.env.BASE_URL}item-icons/moonlit-backsword.png`,
  'Petal Backsword': `${import.meta.env.BASE_URL}item-icons/petal-backsword.png`,
  'Silk Backsword': `${import.meta.env.BASE_URL}item-icons/silk-backsword.png`,
  'Twilight Backsword': `${import.meta.env.BASE_URL}item-icons/twilight-backsword.png`,
  'Steel Backsword': `${import.meta.env.BASE_URL}item-icons/steel-backsword.png`,
  'Bronze Backsword': `${import.meta.env.BASE_URL}item-icons/bronze-backsword.png`,
  'Amber Backsword': `${import.meta.env.BASE_URL}item-icons/amber-backsword.png`,
  'Jade Backsword': `${import.meta.env.BASE_URL}item-icons/jade-backsword.png`,
  'Comet Backsword': `${import.meta.env.BASE_URL}item-icons/comet-backsword.png`,
  'Noble Backsword': `${import.meta.env.BASE_URL}item-icons/noble-backsword.png`,
  'Glow Backsword': `${import.meta.env.BASE_URL}item-icons/glow-backsword.png`,
  'Bloom Backsword': `${import.meta.env.BASE_URL}item-icons/bloom-backsword.png`,
  'Solar Backsword': `${import.meta.env.BASE_URL}item-icons/solar-backsword.png`,
  'Conflict Backsword': `${import.meta.env.BASE_URL}item-icons/conflict-backsword.png`,
  'Origin Backsword': `${import.meta.env.BASE_URL}item-icons/origin-backsword.png`,
  'Mist Backsword': `${import.meta.env.BASE_URL}item-icons/mist-backsword.png`,
  'Zephyr Backsword': `${import.meta.env.BASE_URL}item-icons/zephyr-backsword.png`,
  'Thunder Backsword': `${import.meta.env.BASE_URL}item-icons/thunder-backsword.png`,
  'Conquest Backsword': `${import.meta.env.BASE_URL}item-icons/conquest-backsword.png`,
